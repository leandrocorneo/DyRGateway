...
A resposta do catálogo contém `meta.pagination`, `meta.filters`, `summary` e `items`. Cada item possui identidade lógica, metadados Compose opcionais, estado atual e a última amostra.
